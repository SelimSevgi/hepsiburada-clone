  ...
  return (
    <div className="flex flex-col w-full items-center justify-center ">
      <div className="w-9/12">
        <div className="hidden  md:flex flex-col md:flex-row justify-end items-end mt-2">
          {links.map((link, index) => (
            <a
              href="https://giris.hepsiburada.com/?ReturnUrl=https%3A%2F%2Foauth.hepsiburada.com%2Fconnect%2Fauthorize%2Fcallback%3Fclient_id%3DSPA%26redirect_uri%3Dhttps%253A%252F%252Fwww.hepsiburada.com%252Fuyelik%252Fcallback%26response_type%3Dcode%26scope%3Dopenid%2520profile%26state%3Db772f10d6aa04cc3b1e214f6cd3ba962%26code_challenge%3Duk4B1Fud_rHT-4pGxf9KU6-UisVbowFz6BedwUyMpig%26code_challenge_method%3DS256%26response_mode%3Dquery%26customizeSegment%3DORDERS%26ActivePage%3DPURE_LOGIN%26oidcReturnUrl%3D%252Fsiparislerim"
              className="mr-4  text-xs font-bold text-gray-500 mt-2"
              key={index}
            >
              {link}
            </a>
        ...
        <div className="flex justify-center items-center flex-row mt-2">
          ...
          <div className="flex flex-row justify-center items-center p-2">
            <GrLocation className="text-gray-400 w-6 h-6 mx-3 font-bold" />
            <div>
              <span className="text-black font-bold">Konum</span>
              <div className="flex flex-row justify-center items-center text-orange-500">
                <span className="text">Konum seç</span>
                <BsChevronDown className="ml-4" />
              </div>
            </div>
          </div>
          <div className="flex items-center justify-center border-2 rounded text-gray-800 border-gray-400 p-2 w-40 h-12">
            ...
            <div className="flex flex-col ">
              ...
              <span className="text-xs">veya üye ol</span>
            </div>
