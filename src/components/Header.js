      ...
      <div className="flex flex-col w-full items-center justify-center">
        <div className="w-9/12">
          ...
          <div className="flex justify-center items-center flex-row mt-2">
            ...
            <div className="flex items-center justify-center border-2 border-gray-400 bg-gray-400 text-white rounded w-32 h-12 ml-3 ">
              <FaShoppingCart className="w-5 h-5 mr-2 relative" />
              <div className="bg-white text-gray-400 border-2 rounded-full px-1 w-4 h-4 flex items-center justify-center absolute  top-22 right-110">
        ...
        <div className="w-full h-2 flex ">
          <div className="w-1/6 bg-indigo-600 "></div>
          <div className="w-1/6 bg-cyan-500 "></div>
          <div className="w-1/6 bg-orange-600 "></div>
          <div className="w-1/6 bg-yellow-500"></div>
          <div className="w-1/6 bg-violet-800 "></div>
